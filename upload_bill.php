...
//     $filefield = $_FILES["filefield"]["BillType"];
...
// if ($filefield == null) {
//  $path="";
//     $query = "INSERT INTO proof_bill VALUES ('','$BillType','$path')";
// }
// else {
//    $query = "INSERT INTO proof_bill VALUES ('','$description','$path')";
...
<br>
    ...
    <textarea style="resize: none;padding: 1%;word-wrap: break-word;" type="text" id="issue" name="description" maxlength="200" placeholder="Write here..." required></textarea><br/><br/> -->
      ...
      <strong style="padding: 1%;font-size: 25px;font-weight: bolder;word-wrap: break-word;">Billing Type:  </strong>
    <select style="padding: 1%;font-size: 20px;font-weight: bolder;word-wrap: break-word;" name="BillType">
      <option value="Meralco">Meralco</option>
      <option value="Internet/Telephone/Mobile Phone Bills">Internet/Telephone/Mobile Phone Bills</option>
      <option value="Manila Water Sewerage System Bill">Manila Water Sewerage System Bill</option>
      <option value="TV/Cable Bill">TV/Cable Bill</option>
    </select>
   <br><br>
   ...
   <input id="filefield" type="file" name="Billfilefield" multiple style="padding: 1%;font-size: 25px;font-weight: bolder;word-wrap: break-word;" value="Choose image files" placeholder="Choose image files" /><br></center><br>
