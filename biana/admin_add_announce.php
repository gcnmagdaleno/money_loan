...
<form action="#" method="post" style="padding: 50px;"><center>
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		//touch($strFileName);
		 ...
		 if ($_POST['btnSave'] == "SAVE") {
		 		...
		 		$myfile = fopen($strFileName, "w+") or die("Unable to open file!");
	...
	<input type="text" name="txtFileName" style="padding: 20px;width: 50%;background-color: rgba(52,73,96,0.8);color: white;font-size: 20px;font-weight: bolder;" placeholder="Filename" value="<?php echo $strValue; ?>"><br>
	...
	<textarea name="txtFileBody" placeholder="" style="padding: 20px;width: 50%;background-color: rgba(52,73,96,0.8);color:white;font-size: 20px;font-weight: bolder;" rows="10" cols="20"><?php if ($_POST['btnOpen'] == "OPEN") {
		...
		$myfile = fopen($strFileNameValue.".txt", "r") or die("Unable to open file!");	$txtFileBodyValue = $_POST['txtFileBody'];
		...
		echo "$cars[0]";
				}$_SESSION['strValue'] = $strFileNameValue;
		$strValue=$_SESSION['strValue'];
			}
		}
		} ?>
	</textarea><br>
