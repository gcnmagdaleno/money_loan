  ...
  error_reporting(0);
    ...
    if((trim($v) != "")||(trim($v) != null)||(trim($v) !== "")||(trim($v) !== null)){
        // echo "Successfully Logged-in";
            ...
            if ($position=="user") {
              echo "<script>alert('Successfully Logged-in: user'); window.location.href='user_index.php';</script>";
            }else if ($position=="admin"){
              echo "<script>alert('Successfully Logged-in:admin'); window.location.href='admin_index.php';</script>";
            }
