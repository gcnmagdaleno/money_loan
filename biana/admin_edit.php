...
<div style="padding: 1%; border: 2px solid #242424;border-radius: 8px;word-wrap: break-word;background-color:  #E6E4E8;height: 100%;">
 ...
 <!-- ///////////////////////////////// -->
        ...
        <div class="w3-content" style="height: 120%;padding: 50px" >
...
<b style="text-align: center;font-weight: bolder;font-size: 275%;"> TYPE OF ID UPLOADED (CRUD)</b><br><br>
        
                <?php

                $stmt = $conn->query("SELECT * FROM proof_id WHERE  User_ID=".$_GET['id']);
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
          // print "Name: <p>{".$row[0] $row[1]."}</p>";
            $_SESSION['IDPath']=$row[2];
          echo "<a href='uploads/$row[2]'><img class='img1' src='uploads/$row[2].jpg' style='height:200px;border-radius:20px;'></a><br><br>";   
        }
...
<!-- ///////////////////////////////// -->
        ...
        <div class="w3-content" style="height: 150%;padding: 50px" >

  <div class="w3-panel">

        <b style="text-align: center;font-weight: bolder;font-size: 275%;"> PROOF OF  ACCOUNTED UPLOADED (CRUD)</b><br><br>

<div style="padding: 1%; border: 2px solid #242424;border-radius: 8px;word-wrap: break-word;background-color:  #E6E4E8;height:70%;">
  <center>
  ...
  <span>
      ...
      <?php
        ...
        $stmt = $conn->query("SELECT * FROM proof_bill WHERE  User_ID=".$_GET['id']);
while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
  // print "Name: <p>{".$row[0] $row[1]."}</p>";
    $_SESSION['IDPath']=$row[2];
  echo "<a href='uploads/$row[2]'><img class='img1' src='uploads/$row[2]' style='height:200px;border-radius:20px;'></a><br><br>";
